...
//	private static final int[] SHADOWS_COLORS = new int[] { 0xFF111111,0x00AAAAAA, 0x00AAAAAA };
	private static final int[] SHADOWS_COLORS = new int[] { 0x00468db6,0x00468db6, 0x00468db6 };
	...
	private void initResourcesIfNecessary() {
		if (itemsPaint == null) {
			...
			itemsPaint.setTextSize(TEXT_SIZE*3);//设置未选到的数字的大小
		}
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(TEXT_SIZE*3);  //设置选择到的数字的大小
			//valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFC0C0C0);  //设置选择上的数字的行阴影
			valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFf0f0f0);  //设置选择上的数字的行阴影
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val); //滚轮的颜色梯度
		}
